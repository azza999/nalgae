		...
		<div class="container">
			...
			<div class="jds">
				<div class="jd d-flex justify-content-center align-items-stretch" id="ga">
					...
					<div class="content">
						<div class="jd-row jd-row-first d-flex flex-direction-row-reverse">
							<div class="cell"></div>
						</div>
						<div class="jd-row jd-row-first d-flex flex-direction-row-reverse">
							<div class="cell"></div>
						...
						<div class="jd-row jd-row-first d-flex justify-content-between flex-direction-row-reverse">
							<div class="cell"></div>
							<div class="cell"></div>
						</div>
					</div>
				...
				<div class="jd d-flex justify-content-center align-items-stretch">
					...
					<div class="content">
						<div class="jd-row jd-row-first d-flex justify-content-end flex-direction-row-reverse">
				...
				<div class="jd d-flex justify-content-center align-items-stretch" id="jd1">
					...
					<div class="content">
						...
						<div class="jd-row d-flex justify-content-end flex-direction-row-reverse">
							<div class="cell"></div>
							<div class="cell"></div>
							<div class="cell"></div>
							<div class="cell"></div>
